...
{
    internal class SpongeSlugCometConfig : IEntityConfig, IHasDlcRestrictions
    {
        public static string ID = "MoltenSpongeSlugComet";
        ...
        {
            GameObject entity = EntityTemplates.CreateEntity(SpongeSlugCometConfig.ID, "MoltenSpongeSlugComet");
            entity.AddOrGet<SaveLoadRoot>();
            entity.AddOrGet<LoopingSounds>();
            SpongeSlugComet gassyMooComet = entity.AddOrGet<SpongeSlugComet>();
