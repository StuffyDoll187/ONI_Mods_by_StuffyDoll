...
namespace Chaos_Reigns
{
    ...
    internal class TwitchZoologicalMeteors : StateMachineComponent<TwitchZoologicalMeteors.StatesInstance>, ISaveLoadable
    {
        [MyCmpReq]
        ...
        public class States : GameStateMachine<States, StatesInstance, TwitchZoologicalMeteors, object>
        {
            ...
            public override void InitializeStates(out BaseState default_state)
            {
                ...
                raining.UpdateTransition(clearSkies, new Func<StatesInstance, float, bool>(RainZooMeteors), UpdateRate.SIM_1000ms);
            ...
            private bool RainZooMeteors(StatesInstance smi, float dt)
            {
                ...
                GameObject gameObject = Util.KInstantiate(Assets.GetPrefab("TwitchZoologicalComet"), position);
                gameObject.SetActive(true);
                return smi.master.TimeRemaining <= 0;
            }
        }
        public class StatesInstance : GameStateMachine<States, StatesInstance, TwitchZoologicalMeteors, object>.GameInstance
        {
            public StatesInstance(TwitchZoologicalMeteors master) : base(master) { }
        }
    }
}
