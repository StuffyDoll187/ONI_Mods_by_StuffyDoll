...
{
    public class WaterBalloonCometConfig : IEntityConfig, IHasDlcRestrictions
    {
        public static string ID = "WaterBalloonComet";
        ...
        public GameObject CreatePrefab()
        {
            ...
            Comet comet = entity.AddOrGet<WaterBalloonComet>();
