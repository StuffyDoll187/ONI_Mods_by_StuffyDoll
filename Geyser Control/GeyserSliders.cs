...
namespace Geyser_Control
{
    ...
    internal class GeyserSliders : KMonoBehaviour, IMultiSliderControl , ISidescreenButtonControl, ISim1000ms
    {
        ...
        public GeyserSliders()
        {
            ...
            /*List<ISliderControl> sliders = new List<ISliderControl>() 
            {
            ...
            if (Config.Instance.maxPressureControls)
            {
                sliders.Add(new MaxPressureController(this));

            }

            this.sliderControls = sliders.ToArray();*/
