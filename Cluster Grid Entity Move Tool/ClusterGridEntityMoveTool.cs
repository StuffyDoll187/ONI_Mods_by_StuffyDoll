...
namespace Cluster_Grid_Entity_Move_Tool
{
    ...
    {                
        ...
        {
            ClusterGridEntityMoveTool.Instance = this;
        } 
        ...
        {
            if (ClusterGridEntityMoveTool.clusterMapVisualizer != null)
            {
                ClusterGridEntityMoveTool.clusterMapVisualizer.transform.position = ClusterGridEntityMoveTool.originalHex.transform.position;
                ClusterGridEntityMoveTool.ClearVariables();
            }
        ...
        public static void SetNewLocation()
        {
            ...
            {                
                if (!clusterTraveler.TryGetComponent<ClusterMapMeteorShowerVisualizer>(out ClusterMapMeteorShowerVisualizer _))
                    continue;
                if (clusterTraveler.TryGetComponent<ClusterDestinationSelector>(out ClusterDestinationSelector clusterDestinationSelector))
                {
